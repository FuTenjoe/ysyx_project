...
void Vysyx_22040175_top___024root__traceInitSub0(Vysyx_22040175_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declQuad(c+52,"inst", false,-1, 63,0);
        tracep->declBus(c+54,"pc", false,-1, 31,0);
        tracep->declBus(c+55,"unknown_code", false,-1, 31,0);
        tracep->declBit(c+50,"ysyx_22040175_top clk", false,-1);
        tracep->declBit(c+51,"ysyx_22040175_top rst", false,-1);
        tracep->declQuad(c+52,"ysyx_22040175_top inst", false,-1, 63,0);
        tracep->declBus(c+54,"ysyx_22040175_top pc", false,-1, 31,0);
        tracep->declBus(c+55,"ysyx_22040175_top unknown_code", false,-1, 31,0);
        ...
        tracep->declBus(c+57,"ysyx_22040175_top reg1_rdata", false,-1, 31,0);
        ...
        tracep->declBus(c+54,"ysyx_22040175_top u_pc_reg_0 curr_pc", false,-1, 31,0);
        ...
        tracep->declBus(c+54,"ysyx_22040175_top u_mux_pc_0 curr_pc", false,-1, 31,0);
        tracep->declBus(c+56,"ysyx_22040175_top u_mux_pc_0 next_pc", false,-1, 31,0);
        tracep->declBus(c+58,"ysyx_22040175_top u_ctrl_0 inst", false,-1, 31,0);
        ...
        tracep->declBus(c+55,"ysyx_22040175_top u_ctrl_0 unknown_code", false,-1, 31,0);
        ...
        tracep->declBus(c+57,"ysyx_22040175_top u_reg_file_0 reg1_rdata", false,-1, 31,0);
        ...
        tracep->declBus(c+58,"ysyx_22040175_top u_imm_gen_0 inst", false,-1, 31,0);
        ...
        tracep->declBus(c+57,"ysyx_22040175_top u_mux_alu_0 reg1_rdata", false,-1, 31,0);
        ...
        tracep->declBus(c+54,"ysyx_22040175_top u_mux_alu_0 curr_pc", false,-1, 31,0);
...
void Vysyx_22040175_top___024root__traceFullSub0(Vysyx_22040175_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullQData(oldp+52,(vlSelf->inst),64);
        tracep->fullIData(oldp+54,(vlSelf->pc),32);
        tracep->fullIData(oldp+55,(vlSelf->unknown_code),32);
                                     ...
                                     ? (((IData)(vlSelf->ysyx_22040175_top__DOT__branch) 
                                         ...
                                         : ((IData)(vlSelf->ysyx_22040175_top__DOT__jump)
                                             ...
                                             : ((IData)(4U) 
                                                + vlSelf->pc)))
                                     : vlSelf->pc)),32);
        tracep->fullIData(oldp+57,(((0U == (IData)(vlSelf->ysyx_22040175_top__DOT__reg1_raddr))
                                     ? 0U : vlSelf->ysyx_22040175_top__DOT__u_reg_file_0__DOT__reg_f
                                    [vlSelf->ysyx_22040175_top__DOT__reg1_raddr])),32);
        tracep->fullIData(oldp+58,((IData)(vlSelf->inst)),32);
        tracep->fullCData(oldp+59,((0x7fU & (IData)(vlSelf->inst))),7);
        tracep->fullCData(oldp+60,((7U & (IData)((vlSelf->inst 
                                                  >> 0xcU)))),3);
        tracep->fullCData(oldp+61,((0x7fU & (IData)(
                                                    (vlSelf->inst 
                                                     >> 0x19U)))),7);
        tracep->fullCData(oldp+62,((0x1fU & (IData)(
                                                    (vlSelf->inst 
                                                     >> 7U)))),5);
        tracep->fullCData(oldp+63,((0x1fU & (IData)(
                                                    (vlSelf->inst 
                                                     >> 0xfU)))),5);
        tracep->fullCData(oldp+64,((0x1fU & (IData)(
                                                    (vlSelf->inst 
                                                     >> 0x14U)))),5);
    }
}
