...
void Vysyx_22040175_top___024root__traceInitSub0(Vysyx_22040175_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBit(c+21,"ysyx_22040175_top ena", false,-1);
        ...
        tracep->declBit(c+21,"ysyx_22040175_top u_pc_reg_0 ena", false,-1);
        ...
        tracep->declBit(c+21,"ysyx_22040175_top u_mux_pc_0 ena", false,-1);
        ...
        tracep->declQuad(c+19,"ysyx_22040175_top u_mux_pc_0 reg1_rdata", false,-1, 63,0);
        ...
        tracep->declBus(c+92,"ysyx_22040175_top u_ctrl_0 opcode", false,-1, 6,0);
        tracep->declBus(c+93,"ysyx_22040175_top u_ctrl_0 funct3", false,-1, 2,0);
        tracep->declBus(c+94,"ysyx_22040175_top u_ctrl_0 funct7", false,-1, 6,0);
        tracep->declBus(c+95,"ysyx_22040175_top u_ctrl_0 rd", false,-1, 4,0);
        tracep->declBus(c+96,"ysyx_22040175_top u_ctrl_0 rs1", false,-1, 4,0);
        tracep->declBus(c+97,"ysyx_22040175_top u_ctrl_0 rs2", false,-1, 4,0);
...
void Vysyx_22040175_top___024root__traceFullSub0(Vysyx_22040175_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullIData(oldp+10,(vlSelf->ysyx_22040175_top__DOT__reg1_rdata),32);
        ...
        tracep->fullQData(oldp+19,((QData)((IData)(vlSelf->ysyx_22040175_top__DOT__reg1_rdata))),64);
        tracep->fullBit(oldp+21,(vlSelf->ysyx_22040175_top__DOT__ena));
                                         ...
                                         : (((IData)(vlSelf->ysyx_22040175_top__DOT__jump) 
                                             ...
                                             : (((IData)(vlSelf->ysyx_22040175_top__DOT__jump) 
                                                ...
                                                ((IData)(4U) 
                                                 + vlSelf->pc))))
                                     : vlSelf->pc)),32);
        tracep->fullCData(oldp+92,((0x7fU & vlSelf->inst)),7);
        tracep->fullCData(oldp+93,((7U & (vlSelf->inst 
                                          >> 0xcU))),3);
        tracep->fullCData(oldp+94,((vlSelf->inst >> 0x19U)),7);
