...
void Vysyx_22040175_top___024root__traceChgSub0(Vysyx_22040175_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[4U])) {
            ...
            tracep->chgQData(oldp+2362,(vlSelf->ysyx_22040175_top__DOT__from_ex_alu_res),64);
            tracep->chgBit(oldp+2364,(vlSelf->ysyx_22040175_top__DOT__sh_fnsh_flag));
            tracep->chgQData(oldp+2365,((QData)((IData)(vlSelf->ysyx_22040175_top__DOT__u_if_stage__DOT__u_pc_predict__DOT__curr_pc))),64);
            tracep->chgIData(oldp+2367,((IData)(vlSelf->ysyx_22040175_top__DOT__u_if_stage__DOT__u_pc_predict__DOT__curr_pc)),32);
            tracep->chgWData(oldp+2368,(vlSelf->ysyx_22040175_top__DOT__u_ex_stage__DOT__u_alu__DOT__mul_res),130);
            tracep->chgQData(oldp+2373,(vlSelf->ysyx_22040175_top__DOT__u_ex_stage__DOT__u_alu__DOT__alu_res2),64);
            tracep->chgCData(oldp+2375,(vlSelf->ysyx_22040175_top__DOT__u_ex_stage__DOT__u_alu__DOT__u_mul__DOT__present_state),3);
        }
