...
void Vysyx_22040175_top___024root__traceChgSub0(Vysyx_22040175_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->chgQData(oldp+85,(vlSelf->inst),64);
                                            ...
                                            : (((IData)(vlSelf->ysyx_22040175_top__DOT__jump) 
                                                ...
                                                : ((IData)(vlSelf->ysyx_22040175_top__DOT__ebreak_flag)
                                                   ...
                                                   ((IData)(4U) 
                                                    + vlSelf->pc)))))
                                    : vlSelf->pc)),32);
        tracep->chgIData(oldp+91,((IData)(vlSelf->inst)),32);
        tracep->chgCData(oldp+92,((0x7fU & (IData)(vlSelf->inst))),7);
        tracep->chgCData(oldp+93,((7U & (IData)((vlSelf->inst 
                                                 >> 0xcU)))),3);
        tracep->chgCData(oldp+94,((0x7fU & (IData)(
                                                   (vlSelf->inst 
                                                    >> 0x19U)))),7);
