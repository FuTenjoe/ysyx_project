...
void Vysyx_22040175_top_ctrl___ctor_var_reset(Vysyx_22040175_top_ctrl* vlSelf);

Vysyx_22040175_top_ctrl::Vysyx_22040175_top_ctrl(const char* _vcname__)
    : VerilatedModule(_vcname__)
 {
    // Reset structure values
    Vysyx_22040175_top_ctrl___ctor_var_reset(this);
}

void Vysyx_22040175_top_ctrl::__Vconfigure(Vysyx_22040175_top__Syms* _vlSymsp, bool first) {
    if (false && first) {}  // Prevent unused
    this->vlSymsp = _vlSymsp;
}

Vysyx_22040175_top_ctrl::~Vysyx_22040175_top_ctrl() {
}

void Vysyx_22040175_top_ctrl____Vdpiimwrap_unknown_inst_TOP__ysyx_22040175_top__u_id_stage__u_ctrl();

void Vysyx_22040175_top_ctrl___settle__TOP__ysyx_22040175_top__u_id_stage__u_ctrl__1(Vysyx_22040175_top_ctrl* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vysyx_22040175_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vysyx_22040175_top_ctrl___settle__TOP__ysyx_22040175_top__u_id_stage__u_ctrl__1\n"); );
    // Body
...
void Vysyx_22040175_top_ctrl___ctor_var_reset(Vysyx_22040175_top_ctrl* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vysyx_22040175_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vysyx_22040175_top_ctrl___ctor_var_reset\n"); );
    // Body
