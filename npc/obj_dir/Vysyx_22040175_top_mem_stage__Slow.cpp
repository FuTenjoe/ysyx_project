...
void Vysyx_22040175_top_mem_stage___ctor_var_reset(Vysyx_22040175_top_mem_stage* vlSelf);

Vysyx_22040175_top_mem_stage::Vysyx_22040175_top_mem_stage(const char* _vcname__)
    : VerilatedModule(_vcname__)
 {
    // Reset structure values
    Vysyx_22040175_top_mem_stage___ctor_var_reset(this);
}

void Vysyx_22040175_top_mem_stage::__Vconfigure(Vysyx_22040175_top__Syms* _vlSymsp, bool first) {
    if (false && first) {}  // Prevent unused
    this->vlSymsp = _vlSymsp;
}

Vysyx_22040175_top_mem_stage::~Vysyx_22040175_top_mem_stage() {
}

void Vysyx_22040175_top_mem_stage___settle__TOP__ysyx_22040175_top__u_mem_stage__1(Vysyx_22040175_top_mem_stage* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vysyx_22040175_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vysyx_22040175_top_mem_stage___settle__TOP__ysyx_22040175_top__u_mem_stage__1\n"); );
    // Body
...
void Vysyx_22040175_top_mem_stage___settle__TOP__ysyx_22040175_top__u_mem_stage__2(Vysyx_22040175_top_mem_stage* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vysyx_22040175_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vysyx_22040175_top_mem_stage___settle__TOP__ysyx_22040175_top__u_mem_stage__2\n"); );
    // Body
...
void Vysyx_22040175_top_mem_stage___settle__TOP__ysyx_22040175_top__u_mem_stage__3(Vysyx_22040175_top_mem_stage* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vysyx_22040175_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vysyx_22040175_top_mem_stage___settle__TOP__ysyx_22040175_top__u_mem_stage__3\n"); );
    // Body
...
void Vysyx_22040175_top_mem_stage___ctor_var_reset(Vysyx_22040175_top_mem_stage* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vysyx_22040175_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vysyx_22040175_top_mem_stage___ctor_var_reset\n"); );
    // Body
    ...
    vlSelf->__PVT__sign_alu_res = VL_RAND_RESET_Q(64);
    ...
    vlSelf->__PVT__mem_axi_valid = VL_RAND_RESET_I(1);
    ...
    vlSelf->__PVT__axi_rdata = VL_RAND_RESET_Q(64);
    ...
    vlSelf->__PVT__rd_buf_lw = VL_RAND_RESET_Q(64);
    vlSelf->__PVT__alu_res = VL_RAND_RESET_Q(64);
    vlSelf->__PVT__reg_mstatus = VL_RAND_RESET_Q(64);
    vlSelf->__PVT__present_state = VL_RAND_RESET_I(2);
    vlSelf->__PVT__next_state = VL_RAND_RESET_I(2);
    vlSelf->__PVT__reg_mem_addr = VL_RAND_RESET_Q(64);
    vlSelf->__Vdly__reg_mstatus = VL_RAND_RESET_Q(64);
    vlSelf->__Vdly__present_state = VL_RAND_RESET_I(2);
    vlSelf->__Vdly__mem_send_id = VL_RAND_RESET_I(4);
    vlSelf->__Vdly__reg_mem_addr = VL_RAND_RESET_Q(64);
    vlSelf->__Vdly__reg_rd_buf_flag = VL_RAND_RESET_I(3);
}
