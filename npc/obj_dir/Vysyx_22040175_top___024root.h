...
VL_MODULE(Vysyx_22040175_top___024root) {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ ysyx_22040175_top__DOT__u_id_stage__DOT__clk;
        CData/*0:0*/ ysyx_22040175_top__DOT__u_id_stage__DOT__rst_n;
    ...
    struct {
        ...
        QData/*63:0*/ ysyx_22040175_top__DOT__u_if_stage__DOT__curr_pc;
